  ...
  return (
    <div className="group max-w-sm mx-auto bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 overflow-hidden">
      ...
      <div className="relative overflow-hidden">
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSrQY9RaGIGtMbJE1VePWT9v5h1pDGySLvAnA&s"
          alt="Car"
      ...
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <div className="text-right">
            <span className="text-2xl font-black text-gray-900">$180</span>
            <span className="text-gray-500 text-sm font-medium">/day</span>
          </div>
        </div>

        {/* Feature Tags (Added for extra "prettiness") */}
